module.exports = function(app){
	...
	app.put('/api/comentarios/:typeComment/:idRef/:idComment',comentarios.updateComentarios);
	app.delete('/api/comentarios/:typeComment/:idRef/:idComment',comentarios.deleteComentarios);
}